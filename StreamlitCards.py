...
stat_ranges["Fastball (4S)"]["Chase%"] = {"min": 12, "mid": 23.9, "max": 35}
...
stat_ranges["Fastball (2S) / Sinker"]["Chase%"] = {"min": 10, "mid": 22.5, "max": 38}
...
stat_ranges["Cutter"]["Chase%"] = {"min": 8, "mid": 26.7, "max": 45}
...
stat_ranges["Slider"]["Chase%"] = {"min": 10, "mid": 26.7, "max": 42}
stat_ranges["Slider"]["Zone%-Chase%"] = {"min": 16, "mid": 35.1, "max": 41}
...
stat_ranges["Soft (chg/splt)"]["Chase%"] = {"min": 15, "mid": 30.2, "max": 45}
...
stat_ranges["Breaking (cv/sld/sw)"]["Chase%"] = {"min": 12, "mid": 25.7, "max": 42}
...
total_ranges = {
    "Z-Contact%": {"min": 78.0, "mid": 86.0, "max": 94.1},
    "O-Contact%": {"min": 45.0, "mid": 62.5, "max": 80.0},
    "Contact%": {"min": 68.0, "mid": 80.5, "max": 93.0},
    "InZoneSwing%": {"min": 60.0, "mid": 67.3, "max": 74.7},
    "Chase%": {"min": 25.0, "mid": 34.2, "max": 43.4},
