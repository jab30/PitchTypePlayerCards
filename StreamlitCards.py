...
stat_ranges["Fastball (4S)"]["Chase%"] = {"min": 5, "mid": 21.9, "max": 40}
...
stat_ranges["Fastball (2S) / Sinker"]["Chase%"] = {"min": 5, "mid": 22.5, "max": 45}
...
stat_ranges["Cutter"]["Chase%"] = {"min": 5, "mid": 27.2, "max": 45}
...
stat_ranges["Soft (chg/splt)"]["Chase%"] = {"min": 12, "mid": 29.6, "max": 45}
...
stat_ranges["Breaking (cv/sld/sw)"]["Chase%"] = {"min": 10, "mid": 25.7, "max": 42}
